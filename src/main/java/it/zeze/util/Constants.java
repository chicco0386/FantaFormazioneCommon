...
public class Constants {
    ...
    public static final String CONF_KEY_HTML_FILE_GIOCATORI_GENERAL = "nomeFileHTMLGiocatori";
    public static final String CONF_KEY_HTML_FILE_GIOCATORI_TEMPLATE = "nomeFileHTMLGiocatoriTemplateRuolo";
    public static final String CONF_KEY_HTML_FILE_GIOCATORI_URL = "urlTemplateGiocatori";
